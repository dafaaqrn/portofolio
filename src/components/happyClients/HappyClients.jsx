...
import antartikaLogo from "../../assets/clientlogo/sma-antartika.png";
import wongcocoLogo from "../../assets/clientlogo/wongcoco.png";
import sizendoLogo from "../../assets/clientlogo/sizendo.png";
...
/>,
  ...
  <>
    {/* GOOGLE */}
    <svg className={`${commonSVGClass}`} viewBox="0 0 90 30">
      <path
        fill="#B8BCC2"
  ...
  return (
    <div className="content py-10 md:py-25 flex flex-col items-center px-2">
      <div className="max-w-144.25 text-center ">
        <p className="section-title mb-6">Clients</p>
        <p className="text-[14px] sm:text-lg text-soft-dark font-normal">
        Saya memiliki pengalaman bekerja sama dengan beragam perusahaan, 
        mulai dari startup hingga perusahaan yang telah memiliki 
        posisi yang kuat di industrinya.
        </p>
      </div>
